package com.route.routePlanner.service.impl;
...
public class MatrixGeneraionServiceImpl {
...
//		String url = "http://router.project-osrm.org/table/v1/driving/73.765693,18.6151;73.6879,18.5809;73.9089,18.5793;73.7887,18.5951?annotations=distance";
		return this.generateMatrix(url);
	}
	...
	public JSONObject generateTravelDistanceMatrix(String coordinates) {
		String url = String.format("http://router.project-osrm.org/table/v1/%s/%s", coordinates);
		return this.generateMatrix(url);
	}
	...
	private JSONObject generateMatrix(String url) {
